...
<div class="sidebar" ><b>
  ...
  <a href="manage_videos.php" <?php if($active=='videos') echo "class='act'"; ?>><span class="glyphicon glyphicon-film"></span>&nbsp&nbspManage Videos</a> <!-- New link for Manage Videos -->
</div>
